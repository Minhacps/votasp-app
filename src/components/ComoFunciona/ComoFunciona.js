  ...
  return (
    <section>
      <div className="container">
        ...
        <div className="row">
          <h4 className="text-center">O projeto VotaSP nasceu com o objetivo de ajudar a população do estado de São Paulo a escolher os seus candidatos a deputado Estadual e Federal com mais conciência com base no que defendem em suas campanhas.
          </h4>
        </div>
          ...
          <div className="row"> 
            <div className="col-6 col-lg-3">
              <figure className="passos passo1">
                <img className="icone" src={icone1}
            ...
            <div className="col-6 col-lg-3">
              <figure className="passos passo2">
                <img className="icone" src={icone2}
            ...
            <div className="col-6 col-lg-3">
              <figure className="passos passo3">
                <img className="icone" src={icone3}
            ...
            <div className="col-6 col-lg-3">
              <figure className="passos passo4">  
                <img className="icone" src={icone4}
